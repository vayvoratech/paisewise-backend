...
-- =====================================================================
CREATE TABLE community.answers (
                                   id                  UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_community_answers_post ON community.answers(post_id, is_accepted DESC, upvote_count DESC) WHERE is_removed = false;
CREATE INDEX idx_community_answers_user ON community.answers(user_id, created_at DESC);
